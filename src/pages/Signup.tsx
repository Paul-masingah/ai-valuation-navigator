  ...
  const onSubmit = async (data: SignupFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to PropVision AI! Your account has been created.",
      });
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Or{" "}
            <Link to="/login" className="font-medium text-realestate-teal hover:text-realestate-navy">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    name="terms"
                    type="checkbox"
                    className="h-4 w-4 text-realestate-teal focus:ring-realestate-teal border-gray-300 rounded"
                  />
                  <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                    I agree to the{" "}
                    <a href="#" className="font-medium text-realestate-teal hover:text-realestate-navy">
                      Terms of Service
                    </a>{" "}
                    and{" "}
                    <a href="#" className="font-medium text-realestate-teal hover:text-realestate-navy">
